...
// --- 🎯 ছবি এবং details.js এর ডাটাবেজ স্ট্রাকচার অনুযায়ী নিখুঁত ফেসবুক প্রোপার্টি কার্ড মেকার ---
...
function loadPostAuthorDetails(docId, userId) {
    ...
    }).catch(err => console.error("ইউজার ডাটা ফেচিং এরর কার্ডের জন্য:", err));
}

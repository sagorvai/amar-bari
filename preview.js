...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ⭐ FIX: সুন্দর ডিজাইন অনুযায়ী HTML রেন্ডার করার ফাংশন ⭐
    ...
    editButton.addEventListener('click', () => {
        window.location.href = 'post.html'; // পোস্ট ফর্মে ফিরে যাওয়া
    });
    ...
    confirmButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const newProperty = {
                ...propertyData,
                listerId: uid,
                photos: uploadedUrls, // আপলোড করা URL গুলি দিয়ে প্রতিস্থাপন

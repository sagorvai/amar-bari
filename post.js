// post.js - Fixed with Client-Side Image Compression (KB size), Fast Parallel Uploads & Price Drop Alert
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const BD_GEOGRAPHY = {
        "ঢাকা বিভাগ": {
            ...
            "মুन्সীগঞ্জ": { "উপজেলা": ["মুন্সীগঞ্জ সদর", "টংগিবাড়ী", "শ্রীনগর", "লৌহজং", "গজারিয়া", "সিরাজদিখান"] },
        ...
        "খুলনা বিভাগ": {
            "খুলনা": {
                "সিটি কর্পোরেশন": ["খুলনা সদর", "দৌলতপুর", "খালিশপুর", "خانجاهان আলী", "লবণচরা", "হরিণটানা", "আড়ংঘাটা", "সোনাডাঙ্গা"],
        ...
        "বরিশাল বিভাগ": {
            ...
            "পটুয়াখালী": { "উপজেলা": ["পটুয়াখালী সদর", "বাউফল", "গлаচিপা", "দশমিনা", "কলাপাড়া", "মির্জাগঞ্জ", "دুমকী", "রঙ্গাবালী"] },

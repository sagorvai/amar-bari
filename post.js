...
document.addEventListener('DOMContentLoaded', function() {
    ...
    "ঢাকা বিভাগ": {
        "ঢাকা": {
            "থানা": ["মিরপুর", "উত্তরা", "ধানমন্ডি", "গুলশান", "পল্টন", "মতিঝিল", "শাহবাগ", "মোহাম্মদপুর", "তেজগাঁও", "রমনা", "খিলগাঁও", "বাড্ডা", "মিরপুর মডেল", "কাফরুল", "পল্লবী", "দারুস সালাম", "শাহ আলী", "তুরাগ", "উত্তরখান", "দক্ষিণখান", "খিলক্ষেত", "ভাটারা", "রামপুরা", "সবুজবাগ", "চকবাজার", "কোতোয়ালী", "বংশাল", "সূত্রাপুর", "হাজারীবাগ", "কলাবাগান", "তেজগাঁও শিল্পাঞ্চল", "শেরেবাংলা নগর", "হাতিরঝিল", "কদমতলী", "যাত্রাবাড়ী", "শ্যামপুর", "ডেমরা", "ওয়ারী", "গেন্ডারিয়া", "লালবাগ", "কামরাঙ্গীরচর"],
            "উপজেলা": ["সাভার", "ধামরাই", "কেরানীগঞ্জ", "দোহার", "নবাবগঞ্জ"]
        },
        "গাজীপুর": {
            "থানা": ["গাজীপুর সদর", "কোনাবাড়ী", "বাসন", "গাছা", "টঙ্গী পূর্ব", "টঙ্গী পশ্চিম", "পূবাইল", "কাশিমপুর"],
            "উপজেলা": ["কালিয়াকৈর", "কালীগঞ্জ", "শ্রীপুর", "কাপাসিয়া", "গাজীপুর সদর"]
        },
        "নারায়ণগঞ্জ": {
            "থানা": ["নারায়ণগঞ্জ সদর", "সিদ্ধিরগঞ্জ", "বন্দর"],
            "উপজেলা": ["আড়াইহাজার", "রূপগঞ্জ", "সোনারগাঁও", "নারায়ণগঞ্জ সদর", "বন্দর"]
        },
        "টাঙ্গাইল": { "উপজেলা": ["টাঙ্গাইল সদর", "কালিহাতী", "ঘাটাইল", "মির্জাপুর", "মধুপুর", "গোপালপুর", "সখিপুর", "ভূঞাপুর", "বাসাইল", "দেলদুয়ার", "নাগরপুর", "ধনবাড়ী"] },
        "ফরিদপুর": { "উপজেলা": ["ফরিদপুর সদর", "বোয়ালমারী", "আলফাডাঙ্গা", "নগরকান্দা", "ভাঙ্গা", "সদরপুর", "চরভদ্রাসন", "সালথা", "মধুখালী"] },
        "মানিকগঞ্জ": { "উপজেলা": ["মানিকগঞ্জ সদর", "সিংগাইর", "শিবালয়", "ঘিওর", "হরিরামপুর", "সাটুরিয়া", "দৌলতপুর"] },
        "মুন্সীগঞ্জ": { "উপজেলা": ["মুন্সীগঞ্জ সদর", "টংগিবাড়ী", "শ্রীনগর", "লৌহজং", "গজারিয়া", "সিরাজদিখান"] },
        "নরসিংদী": { "উপজেলা": ["নরসিংদী সদর", "পলাশ", "শিবপুর", "মনোহরদী", "বেলাবো", "রায়পুরা"] },
        "মাদারীপুর": { "উপজেলা": ["মাদারীপুর সদর", "শিবচর", "কালকিনি", "রাজৈর", "ডাসার"] },
        "গোপালগঞ্জ": { "উপজেলা": ["গোপালগঞ্জ সদর", "টুঙ্গিপাড়া", "কোটালীপাড়া", "কাশিয়ানী", "মুকসুদপুর"] },
        "রাজবাড়ী": { "উপজেলা": ["রাজবাড়ী সদর", "গোয়ালন্দ", "পাংশা", "বালিয়াকান্দি", "কালুখালী"] },
        "শরীয়তপুর": { "উপজেলা": ["শরীয়তপুর সদর", "ডামুড্যা", "নড়িয়া", "জাজিরা", "ভেদরগঞ্জ", "গোসাইরহাট"] },
        "কিশোরগঞ্জ": { "উপজেলা": ["কিশোরগঞ্জ সদর", "করিমগঞ্জ", "তাড়াইল", "হোসেনপুর", "পাকুন্দিয়া", "কটিয়াদী", "বাজিতপুর", "কুলিয়ারচর", "ভৈরব", "নিকলী", "মিঠামইন", "ইটনা", "অষ্টগ্রাম"] }
    },
    "চট্টগ্রাম বিভাগ": {
        "চট্টগ্রাম": {
            "থানা": ["কোতোয়ালী", "ডবলমুরিং", "পাঁচলাইশ", "খুলশী", "চান্দগাঁও", "পতেঙ্গা", "পাহাড়তলী", "বন্দর", "বাকলিয়া", "বায়োজিদ বোস্তামী", "হালিশহর", "আকবর শাহ", "কর্ণফুলী", "চকবাজার", "সদরঘাট"],
            "উপজেলা": ["হাটহাজারী", "সীতাকুণ্ড", "মিরসরাই", "পটিয়া", "রাউজান", "রাঙ্গুনিয়া", "বোয়ালখালী", "আনোয়ারা", "চন্দনাইশ", "বাঁশখালী", "সাতকানিয়া", "লোহাগাড়া", "সন্দীপ", "ফটিকছড়ি", "কর্ণফুলী"]
        },
        "কুমিল্লা": {
            "থানা": ["কুমিল্লা সদর", "কোতোয়ালী মেট্রো", "সদর দক্ষিণ"],
            "উপজেলা": ["কুমিল্লা আদর্শ সদর", "কুমিল্লা সদর দক্ষিণ", "লাকসাম", "চৌদ্দগ্রাম", "নাঙ্গলকোট", "বরুড়া", "চান্দিনা", "বুড়িচং", "ব্রাহ্মণপাড়া", "দেবীদ্বার", "মুরাদনগর", "দাউদকান্দি", "হোমনা", "তিতাস", "মেঘনা", "মনোহরগঞ্জ", "লালমাই"]
        },
        "কক্সবাজার": { "উপজেলা": ["কক্সবাজার সদর", "উখিয়া", "টেকনাফ", "রামু", "চকরিয়া", "মহেশখালী", "পেকুয়া", "কুতুবদিয়া", "ঈদগাঁও"] },
        "ফেনী": { "উপজেলা": ["ফেনী সদর", "দাগনভূঞা", "ছাগলনাইয়া", "পরশুরাম", "ফুলগাজী", "সোনাগাজী"] },
        "ব্রাহ্মণবাড়িয়া": { "উপজেলা": ["ব্রাহ্মণবাড়িয়া সদর", "আশুগঞ্জ", "সরাইল", "নাসিরনগর", "নবীনগর", "বাঞ্ছারামপুর", "কসবা", "আখাউড়া", "বিজয়নগর"] },
        "নোয়াখালী": { "উপজেলা": ["নোয়াখালী সদর", "কোম্পানীগঞ্জ", "বেগমগঞ্জ", "চাটখিল", "সেনবাগ", "হাতিয়া", "চৌমুহনী", "সুবর্ণচর", "কবীরহাট", "সোনাইমুড়ী"] },
        "লক্ষ্মীপুর": { "উপজেলা": ["লক্ষ্মীপুর সদর", "রায়পুর", "রামগঞ্জ", "রামগতি", "কমলনগর"] },
        "চাঁদপুর": { "উপজেলা": ["চাঁদপুর সদর", "হাজীগঞ্জ", "কচুয়া", "ফরিদগঞ্জ", "মতলব উত্তর", "মতলব দক্ষিণ", "হাইমচর", "শাহরাস্তি"] },
        "খাগড়াছড়ি": { "উপজেলা": ["খাগড়াছড়ি সদর", "দীঘিনালা", "পানছড়ি", "মাটিরাঙ্গা", "মহালছড়ি", "মানিকছড়ি", "রামগড়", "গুইমারা", "লক্ষ্মীছড়ি"] },
        "রাঙ্গামাটি": { "উপজেলা": ["রাঙ্গামাটি সদর", "কাপ্তাই", "কাউখালী", "বাঘাইছড়ি", "লংগদু", "রাজস্থলী", "জুরাছড়ি", "বেলাইছড়ি", "নানিয়ারচর", "বরকল"] },
        "বান্দরবান": { "উপজেলা": ["বান্দরবান সদর", "লামা", "আলীকদম", "নাইক্ষ্যংছড়ি", "রুমা", "থানচি", "রোয়াংছড়ি"] }
    },
    "খুলনা বিভাগ": {
        "খুলনা": {
            "থানা": ["খুলনা সদর", "দৌলতপুর", "খালিশপুর", "খানজাহান আলী", "লবণচরা", "হরিণটানা", "আড়ংঘাটা", "সোনাডাঙ্গা"],
            "উপজেলা": ["বটিয়াঘাটা", "দাকোপ", "ডুমুরিয়া", "দীঘলিয়া", "কয়রা", "পাইকগাছা", "ফুলতলা", "রূপসা", "তেরখাদা"]
        },
        "যশোর": { "উপজেলা": ["যশোর সদর", "অভয়নগর", "বাঘেরপাড়া", "চৌগাছা", "ঝিকরগাছা", "কেশবপুর", "মণিরামপুর", "শার্শা"] },
        "কুষ্টিয়া": { "উপজেলা": ["কুষ্টিয়া সদর", "কুমারখালী", "খোকসা", "মিরপুর", "ভেড়ামারা", "দৌলতপুর"] },
        "বাগেরহাট": { "উপজেলা": ["বাগেরহাট সদর", "চিতলমারী", "ফকিরহাট", "কচুয়া", "মোল্লাহাট", "মোংলা", "মোরেলগঞ্জ", "রামপাল", "শরণখোলা"] },
        "সাতক্ষীরা": { "উপজেলা": ["সাতক্ষীরা সদর", "কলারোয়া", "তালা", "দেবহাটা", "কালীগঞ্জ", "শ্যামনগর", "আশাশুনি"] },
        ...
        "নড়াইল": { "উপজেলা": ["নড়াইল সদর", "লোহাগড়া", "কালিয়া"] },
        "মেহেরপুর": { "উপজেলা": ["মেহেরপুর সদর", "গাংনী", "মুজিবনগর"] },
        "চুয়াডাঙ্গা": { "উপজেলা": ["চুয়াডাঙ্গা সদর", "আলমডাঙ্গা", "দামুড়হুদা", "জীবননগর"] }
    },
    "রাজশাহী বিভাগ": {
        "রাজশাহী": {
            "থানা": ["বোয়ালিয়া", "রাজপাড়া", "মতিহার", "শাহ মখদুম", "চন্দ্রিমা", "কাটাখালী"],
            "উপজেলা": ["পবা", "গোদাগাড়ী", "তানোর", "মোহনপুর", "বাগমারা", "দুর্গাপুর", "পুঠিয়া", "চারঘাট", "বাঘা"]
        },
        "বগুড়া": { "উপজেলা": ["বগুড়া সদর", "শাজাহানপুর", "শেরপুর", "ধুনট", "গাবতলী", "সারিয়াকান্দি", "নন্দীগ্রাম", "কাহালু", "আদমদীঘি", "দুপচাঁচিয়া", "শিবগঞ্জ", "সোনাতলা"] },
        "পাবনা": { "উপজেলা": ["পাবনা সদর", "ঈশ্বরদী", "আটঘরিয়া", "চাটমোহর", "ভাঙ্গুড়া", "ফরিদপুর", "সুজানগর", "বেড়া", "সাঁথিয়া"] },
        "নাটোর": { "উপজেলা": ["নাটোর সদর", "সিংড়া", "বড়াইগ্রাম", "গুরুদাসপুর", "লালপুর", "বাগাতিপাড়া", "নলডাঙ্গা"] },
        "নওগাঁ": { "উপজেলা": ["নওগাঁ সদর", "রানীনগর", "আত্রাই", "মহাদেবপুর", "বদলগাছী", "পত্নীতলা", "ধামইরহাট", "নিয়ামতপুর", "পোরশা", "সাপাহার", "মান্দা"] },
        "জয়পুরহাট": { "উপজেলা": ["জয়পুরহাট সদর", "পাঁচবিবি", "আক্কেলপুর", "ক্ষেতলাল", "কালাই"] },
        "সিরাজগঞ্জ": { "উপজেলা": ["সিরাজগঞ্জ সদর", "বেলকুচি", "চৌহালী", "কামারখন্দ", "কাজীপুর", "রায়গঞ্জ", "শাহজাদপুর", "তাড়াশ", "উল্লাপাড়া"] },
        "চাঁপাইনবাবগঞ্জ": { "উপজেলা": ["চাঁপাইনবাবগঞ্জ সদর", "শিবগঞ্জ", "গোমস্তাপুর", "নাচোল", "ভোলাহাট"] }
    },
    "বরিশাল বিভাগ": {
        "বরিশাল": {
            "থানা": ["কোতোয়ালী মেট্রো", "কাউনিয়া", "বন্দর মেট্রো", "এয়ারপোর্ট মেট্রো"],
            "উপজেলা": ["বরিশাল সদর", "বাকেরগঞ্জ", "বাবুগঞ্জ", "উজিরপুর", "বানারীপাড়া", "গৌরনদী", "আগৈলঝারা", "মেহেন্দিগঞ্জ", "মুলাদী", "হিজলা"]
        },
        "পটুয়াখালী": { "উপজেলা": ["পটুয়াখালী সদর", "বাউফল", "গলাচিপা", "দশমিনা", "কলাপাড়া", "মির্জাগঞ্জ", "দুমকী", "রাঙ্গাবালী"] },
        "ভোলা": { "উপজেলা": ["ভোলা সদর", "দৌলতখান", "বোরহানউদ্দিন", "তজুমদ্দিন", "লালমোহন", "চরফ্যাশন", "মনপুরা"] },
        "পিরোজপুর": { "উপজেলা": ["পিরোজপুর সদর", "নাজিরপুর", "নেছারাবাদ", "কাউখালী", "ভাণ্ডারিয়া", "মঠবাড়িয়া", "ইন্দুরকানী"] },
        "বরগুনা": { "উপজেলা": ["বরগুনা সদর", "আমতলী", "তালতলী", "বামনা", "পাথরঘাটা", "বেতাগী"] },
        "ঝালকাঠি": { "উপজেলা": ["ঝালকাঠি সদর", "নলছিটি", "রাজাপুর", "কাঠালিয়া"] }
    },
    "সিলেট বিভাগ": {
        "সিলেট": {
            "থানা": ["কোতোয়ালী", "শাহপরান", "এয়ারপোর্ট", "মোগলাবাজার", "দক্ষিণ সুরমা"],
            "উপজেলা": ["সিলেট সদর", "গোলাপগঞ্জ", "বিয়ানীবাজার", "জৈন্তাপুর", "গোয়াইনঘাট", "কানাইঘাট", "কোম্পানীগঞ্জ", "বালাগঞ্জ", "বিশ্বনাথ", "ফেঞ্চুগঞ্জ", "জকিগঞ্জ", "ওসমানীনগর"]
        },
        "সুনামগঞ্জ": { "উপজেলা": ["সুনামগঞ্জ সদর", "শান্তিগঞ্জ", "দোয়ারাবাজার", "ছাতক", "জগন্নাথপুর", "দিরাই", "শাল্লা", "ধর্মপাশা", "তাহিরপুর", "বিশ্বম্ভরপুর", "মধ্যনগর"] },
        "হবিগঞ্জ": { "উপজেলা": ["হবিগঞ্জ সদর", "শায়েস্তাগঞ্জ", "নবীগঞ্জ", "বাহুবল", "আজমিরীগঞ্জ", "বানিয়াচং", "লাখাই", "চুনারুঘাট", "মাধবপুর"] },
        "মৌলভীবাজার": { "উপজেলা": ["মৌলভীবাজার সদর", "শ্রীমঙ্গল", "কমলগঞ্জ", "রাজনগর", "কুলাউড়া", "জুড়ী", "বড়লেখা"] }
    },
    "রংপুর বিভাগ": {
        "রংপুর": {
            "থানা": ["কোতোয়ালী মেট্রো", "পরশুরাম", "তাজহাট", "মাহিগঞ্জ", "হারাগাছ"],
            "উপজেলা": ["রংপুর সদর", "মিঠাপুকুর", "পীরগঞ্জ", "পীরগাছা", "কাউনিয়া", "গঙ্গাচড়া", "তারাগঞ্জ", "বদরগঞ্জ"]
        },
        "দিনাজপুর": { "উপজেলা": ["দিনাজপুর সদর", "বিরল", "বোচাগঞ্জ", "কাহারোল", "বীরগঞ্জ", "চিরিরবন্দর", "পার্বতীপুর", "ফুলবাড়ী", "নবাবগঞ্জ", "বিরামপুর", "হাকিমপুর", "ঘোড়াঘাট", "খানসামা"] },
        "গাইবান্ধা": { "উপজেলা": ["গাইবান্ধা সদর", "সাদুল্লাপুর", "পলাশবাড়ী", "গোবیندগঞ্জ", "সুন্দরগঞ্জ", "সাঘাটা", "ফুলছড়ি"] },
        "কুড়িগ্রাম": { "উপজেলা": ["কুড়িগ্রাম সদর", "রাজারহাট", "উলিপুর", "চিলমারী", "রৌমারী", "চর রাজিবপুর", "নাগেশ্বরী", "ভুরুঙ্গামারী", "ফুলবাড়ী"] },
        "নীলফামারী": { "উপজেলা": ["নীলফামারী সদর", "সৈয়দপুর", "ডোমার", "ডিমলা", "জলঢাকা", "কিশোরগঞ্জ"] },
        "লালমনিরহাট": { "উপজেলা": ["লালমনিরহাট সদর", "আদিতমারী", "কালীগঞ্জ", "হাতীবান্ধা", "পাটগ্রাম"] },
        "পঞ্চগড়": { "উপজেলা": ["পঞ্চগড় সদর", "বোদা", "দেবীগঞ্জ", "অটোয়ারী", "তেঁতুলিয়া"] },
        "ঠাকুরগাঁও": { "উপজেলা": ["ঠাকুরগাঁও সদর", "বালীয়াডাঙ্গী", "পীরগঞ্জ", "রাণীশংকৈল", "হরিপুর"] }
    },
    "ময়মনসিংহ বিভাগ": {
        "ময়মনসিংহ": {
            "থানা": ["ময়মনসিংহ সদর মেট্রো", "কোতোয়ালী"],
            "উপজেলা": ["ময়মনসিংহ সদর", "মুক্তাগাছা", "ফুলবাড়ীয়া", "ত্রিশাল", "ভালুকা", "গফরগাঁও", "নন্দাইল", "ঈশ্বরগঞ্জ", "গৌরীপুর", "হালুয়াঘাট", "ধোবাউড়া", "ফুলপুর", "তারাকান্দা"]
        },
        "নেত্রকোনা": { "উপজেলা": ["নেত্রকোনা সদর", "বারহাট্টা", "কলমাকান্দা", "দুর্গাপুর", "পূর্বধলা", "মোহনগঞ্জ", "আটপাড়া", "মদন", "খালিয়াজুরী", "কেন্দুয়া"] },
        "জামালপুর": { "উপজেলা": ["জামালপুর সদর", "মেলান্দহ", "ইসলামপুর", "দেওয়ানগঞ্জ", "বকশীগঞ্জ", "মাদারগঞ্জ", "সরিষাবাড়ী"] },
        "শেরপুর": { "উপজেলা": ["শেরপুর সদর", "নালিতাবাড়ী", "শ্রীবরদী", "ঝিনাইগাতী", "নকলা"] }
    }
};

// post.js - Revised for direct Firebase Storage upload, Canvas Compression, and Facebook-style Progress UI
// Project: Amar Bari (আমার বাড়ি.কম)
    ...
    return new Promise((resolve, reject) => {
        ...
        reader.onload = (event) => {
            ...
            img.onload = () => {
                ...
                // ইমেজ সাইজ বড় হলে স্কেল ডাউন করা
                if (width > maxWidth) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateSpecificFields(category, type, stagedData = null, stagedMetadata = null) {
        ...
        // রি-লোডের পর সেশনে সেভ থাকা ডাটা স্ক্রিনে দেখানো
        if (stagedMetadata) {
    ...
    // সেশনে আগে থেকে থাকা ডাটা স্ক্রিনে রেন্ডার করার হেল্পার
    ...
    // ৩. মূল আপলোড প্রসেসিং ফাংশন (কম্প্রেশন এবং লাইভ পার্সেন্টেজ লুপসহ)

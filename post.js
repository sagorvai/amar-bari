...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const BD_GEOGRAPHY = {
        "ঢাকা বিভাগ": {
            ...
            "টাঙ্গাইল": { "উপজেলা": ["টাঙ্গাইল সদর", "কালিহাতী", "ঘাটাইল", "মির্জাপুর", "مધુপুর", "গোপালপুর", "সখিপুর", "ভূঞাপুর", "বাসাইল", "দেলদুয়ার", "নাগরপুর", "ধনবাড়ী"] },
            "ফریدপুর": { "উপজেলা": ["ফریدপুর সদর", "কমলগঞ্জ", "বোালমারী", "আলফাডাঙ্গা", "নগরকান্দা", "ভাঙ্গা", "সদরপুর", "চরভদ্রাসন", "সালথা"] },
        ...
        "খুলনা বিভাগ": {
            "খুলনা": {
                "সিটি কর্পোরেশন": ["খুলনা সদর", "দৌলতপুর", "খালিশপুর", "خان জাহান আলী", "লবণচরা", "হরিণটানা", "আড়ংঘাটা", "সোনাডাঙ্গা"],
                "উপজেলা": ["বটিয়াঘাটা", "দাকোপ", "ডুমুরিয়া", "দিঘলিয়া", "কয়রা", "পাইকগাছা", "ফুলতলা", "রূপসা", "তেরখাদা"]
            },
            "যсход": { "উপজেলা": ["যশোর সদর", "অভয়নগর", "বাঘেরপাড়া", "চৌগাছা", "ঝিকরগাছা", "কেশবপুর", "মণিরামপুর", "শার্শা"] },
        ...
        "সিলেট বিভাগ": {
            ...
            "مؤلوی‌বাজার": { "উপজেলা": ["مৌলভীবাজার সদর", "শ্রীমঙ্গল", "কমলগঞ্জ", "রাজনগর", "কুলাউড়া", "জুড়ী", "বড়লেখা"] }
        },
        "রংপুর বিভাগ": {
            "রংপুর": {
        ...
        setTimeout(() => {
            ...
            areaTypeSelect?.addEventListener('change', function() {
                ...
                if (selectedType && BD_GEOGRAPHY[selectedDiv]?.[selectedDist]?.[selectedType]) {
                    ...
                    document.getElementById('thana-upazila-label').textContent = selectedType === 'সিটি কর্পোরেশন' ? "মেтроোপলিটন থানা:" : "উপজেলা:";

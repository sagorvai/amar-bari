...
document.addEventListener('DOMContentLoaded', function() {
    ...
    "ঢাকা বিভাগ": {
        ...
        "গাজীপুর": {
            "সিটি কর্পোরেশন": ["গাজীপুর সদর", "কোনাবাড়ী", "বাসন", "গাছা", "টঙ্গী পূর্ব", "টঙ্গী পশ্চিম", "পূবাইল", "কাশিমপুর"],
            "উপজেলা": ["কালিয়াকৈর", "কালীগঞ্জ", "শ্রীপুর", "কাপাসিয়া", "গাজীপুর সদর"]
        },
        "নারায়ণগঞ্জ": {
            "সিটি কর্পোরেশন": ["নারায়ণগঞ্জ সদর", "সিদ্ধিরগঞ্জ", "বন্দর"],
    ...
    "চট্টগ্রাম বিভাগ": {
        "চট্টগ্রাম": {
            "সিটি কর্পোরেশন": ["কোতোয়ালী", "ডবলমুরিং", "পাঁচলাইশ", "খুলশী", "চান্দগাঁও", "পতেঙ্গা", "পাহাড়তলী", "বন্দর", "বাকলিয়া", "বায়োজিদ বোস্তামী", "হালিশহর", "আকবর শাহ", "কর্ণফুলী", "চকবাজার", "সদরঘাট"],
        ...
        "কুমিল্লা": {
            "সিটি কর্পোরেশন": ["কুমিল্লা সদর", "কোতোয়ালী মেট্রো", "সদর দক্ষিণ"],
    ...
    "খুলনা বিভাগ": {
        "খুলনা": {
            "সিটি কর্পোরেশন": ["খুলনা সদর", "দৌলতপুর", "খালিশপুর", "খানজাহান আলী", "লবণচরা", "হরিণটানা", "আড়ংঘাটা", "সোনাডাঙ্গা"],
    ...
    "রাজশাহী বিভাগ": {
        "রাজশাহী": {
            "সিটি কর্পোরেশন": ["বোয়ালিয়া", "রাজপাড়া", "মতিহার", "শাহ মখদুম", "চন্দ্রিমা", "কাটাখালী"],
    ...
    "বরিশাল বিভাগ": {
        "বরিশাল": {
            "সিটি কর্পোরেশন": ["কোতোয়ালী মেট্রো", "কাউনিয়া", "বন্দর মেট্রো", "এয়ারপোর্ট মেট্রো"],
    ...
    "সিলেট বিভাগ": {
        "সিলেট": {
            "সিটি কর্পোরেশন": ["কোতোয়ালী", "শাহপরান", "এয়ারপোর্ট", "মোগলাবাজার", "দক্ষিণ সুরমা"],
    ...
    "রংপুর বিভাগ": {
        "রংপুর": {
            "সিটি কর্পোরেশন": ["কোতোয়ালী মেট্রো", "পরশুরাম", "তাজহাট", "মাহিগঞ্জ", "হারাগাছ"],
    ...
    "ময়মনসিংহ বিভাগ": {
        "ময়মনসিংহ": {
            "সিটি কর্পোরেশন": ["ময়মনসিংহ সদর মেট্রো", "কোতোয়ালী"],
